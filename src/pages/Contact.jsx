        ...
        <div className="bg-gray-50">
            ...
            <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-base md:text-xl text-blue-100">We are always ready for your service</p>
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Book Your Service</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isSubmitting}
                            className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white py-4 px-6 rounded-lg font-semibold flex items-center justify-center space-x-2 transition-all transform hover:scale-105 disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                            {isSubmitting ? (
                                <>
                                    <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900">Office Address</h3>
                                    <p className="text-gray-600">
                                        Shop No. 15, Shivaji Complex,
                                        <br /> Near City Mall, Pune Road,
                                        <br /> Maharashtra - 411001
                                    </p>
                                </div>
                            </div>
                            {/* Hours */}
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a
                                ...
                                className="bg-blue-400 hover:bg-blue-500 p-3 rounded-full transition transform hover:scale-110"
                            >
                                <Twitter className="w-6 h-6 text-white" />
                            </a>
                        </div>

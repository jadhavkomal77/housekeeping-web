...
const PaymentOptions = () => {
    ...
    const otherPayments = [
        ...
        },
        {
            ...
            text: "text-blue-600",
            icon: CreditCard,
            items: ["Account: Techno Housekeeping", "A/C No: 1234567890123456", "IFSC: SBIN0001234", "Bank: State Bank of India"],
        },
        {
            title: "Card Payment",
    ...
    return (
        <div className="bg-gray-50 py-8 px-4 md:px-12 min-h-screen overflow-x-hidden">
            <motion.div
                className="max-w-6xl mx-auto bg-white rounded-3xl shadow-xl p-6 md:p-12"
                initial="hidden"
                animate="visible"
                variants={fadeUp}
            ...
            >
                ...
                <motion.section
                    className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-start mb-12"
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true }}
                ...
                >
                    ...
                    <motion.div className="flex flex-col items-center text-center" variants={fadeUp}>
                        ...
                        <motion.div
                            className="relative w-full max-w-[350px] p-4 bg-white rounded-xl border shadow-md hover:shadow-xl transition-transform transform hover:scale-105"
                        ...
                        <motion.button
                            ...
                            className="px-5 py-3 w-full sm:w-auto bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium rounded-xl mt-6 inline-flex items-center justify-center"
                            whileHover={{ scale: 1.03 }}
                            whileTap={{ scale: 0.97 }}
                        >
                            Pay with PhonePe
                    ...
                    {/* Instructions */}
                    <motion.aside className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 shadow-md" variants={fadeUp}>
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {otherPayments.map((option, idx) => (
                            <motion.article
                                key={idx}
                                className="bg-white border rounded-2xl shadow-md hover:shadow-xl p-6 transition transform hover:-translate-y-1 cursor-pointer"
                                variants={fadeUp}
                                whileHover={{ scale: 1.03 }}
                            >
                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-8">
                        {[ShieldCheck, Users, Lock].map((Icon, idx) => (
                            <motion.div
                                key={idx}
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-600 mt-2">
                                    {idx === 0 ? "100% Secure" : idx === 1 ? "Trusted by 1000+ Users" : "SSL Encrypted"}
                                </p>
                            </motion.div>
                        ))}
                        <motion.div className="flex flex-col items-center hover:scale-105 transition" whileHover={{ scale: 1.03 }}>

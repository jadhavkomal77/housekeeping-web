...
const PaymentOptions = () => {
    ...
    // Open PhonePe with fallback
    const handlePhonePeClick = () => {
        // Try to open the UPI app (PhonePe) using deep link
        ...
        <div className="bg-gray-50 py-12 px-6 md:px-12 min-h-screen">
            <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-xl p-8 md:p-12">
                ...
                <header className="text-center mb-12">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-blue-700 mb-2">Techno Housekeeping</h1>
                    <p className="text-lg text-gray-600">Hassle-free & secure payment options</p>
                </header>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start mb-12">
                    ...
                    <div className="text-center">
                        ...
                        <div className="inline-block rounded-xl border shadow-md p-4 bg-white hover:shadow-xl transition-transform transform hover:scale-105">
                            <QRCodeCanvas

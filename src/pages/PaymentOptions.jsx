...
//     const phonePeLink = `upi://pay?pa=${encodeURIComponent(
//         upiId
//     )}&pn=${encodeURIComponent("Techno Housekeeping")}&cu=INR&tn=${encodeURIComponent(
...
//     return (
//         <div className="bg-gray-50 py-12 px-4 md:px-12 min-h-screen overflow-x-hidden">
...
//                 <section className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-start mb-12">
//                     {/* Left: UPI */}
//                     <div className="text-center">
//                         <h2 className="text-2xl font-bold text-gray-900 mb-6">Pay via UPI</h2>

//                         <div className="inline-block rounded-xl border shadow-md p-4 bg-white hover:shadow-xl transition-transform transform hover:scale-105 mx-auto">
//                             <QRCodeCanvas
...
//                         <div
//                             className="flex justify-center items-center gap-2 bg-gray-100 rounded-xl py-2 px-4 w-fit mx-auto mt-2 cursor-pointer hover:bg-gray-200 transition"
...
//                                 className="px-5 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium rounded-xl hover:from-purple-700 hover:to-indigo-700 transition inline-flex items-center justify-center"
//                             >
//                                 Pay with PhonePe
//                             </button>
//                         </div>
...
//                                     <div className={clsx(option.bg, "p-4 rounded-full w-20 h-20 flex items-center justify-center mb-4")}>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-start mb-12">
                    <div className="flex flex-col items-center text-center">
                        ...
                        {/* <div className="flex justify-center w-full">
                            <div className="rounded-xl border shadow-md p-4 bg-white hover:shadow-xl transition-transform transform hover:scale-105 w-full max-w-xs">
                                <QRCodeCanvas
                                    value={`upi://pay?pa=${upiId}&pn=Techno%20Housekeeping&cu=INR&tn=Payment`}
                                    size={qrSize}
                                    level="H"
